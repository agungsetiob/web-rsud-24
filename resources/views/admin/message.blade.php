...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="" onclick="this.href='messages/laporan/'+ document.getElementById('startdate').value + '/' +document.getElementById('enddate').value" class="d-none d-sm-inline-block btn btn-warning shadow-sm" target="_blank"><i class="fas fa-print"></i> Cetak</a>
    </div>
</div>
<!-- /.container-fluid -->
