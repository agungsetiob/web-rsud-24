...
@fragment('contact')
    <div id="app" data-loading-class="fade">
        ...
        <div id="contact" class="container-fluid appointment py-5">
                        ...
                        <div class="appointment-form rounded p-5">
                            ...
                            <form id="contactForm" method="POST">
                                ...
                                <div class="row gy-3 gx-4">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control border-primary bg-transparent text-dark"
                                    ...
                                    <div class="col-12">
                                        <button type="submit" id="submitButton"
                                            class="btn btn-primary text-white w-100 py-3 px-5">KIRIM</button>
                                    </div>
                                </div>
                            </form>
                        </div>
